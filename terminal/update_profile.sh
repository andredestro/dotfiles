...
# Terminal
#
# Use a modified version of the Solarized Dark profile by default in Terminal.app

startup_window_settings=$(defaults read com.apple.Terminal "Startup Window Settings")
default_window_settings=$(defaults read com.apple.Terminal "Default Window Settings")

if [[ $startup_window_settings = "Solarized Dark" && $default_window_settings = "Solarized Dark" ]]; then
